...
This directory contains project management, development, and internal documentation for the Simple DNS Daemon project.
...
For user-facing documentation (installation, configuration, usage guides), see the **[docs/](../docs/)** directory (if available).
