...
:build_project
call :print_status "Building simple-dnsd..."
...
:install_project
if "%INSTALL%"=="true" (
    call :print_status "Installing simple-dnsd..."
    cd /d "%BUILD_DIR%"
...
if "%ENABLE_STATIC_LINKING%"=="ON" (
    ...
    copy "%BUILD_DIR%\simple-dnsd.exe" "%STATIC_DIR%\"
...
:show_usage
echo simple-dnsd - Windows Build Script
echo.
...
REM Main execution
:main
call :print_status "Starting simple-dnsd build process..."
...
call :print_success "simple-dnsd build process completed successfully!"
goto :end
