...
REMOTE_PROJECT_DIR="/opt/simple-dnsd"
...
- name: Collect packages from remote VMs
  ...
  vars:
    ...
    remote_dist_dir: "/opt/simple-dnsd/dist"
    remote_build_dir: "/opt/simple-dnsd/build"
    remote_centralized_dir: "/opt/simple-dnsd/dist/centralized/v$VERSION"
